  ...
  <footer class="pb-4 bg-primary-3 text-light" id="footer">
    <div class="container">
      <div class="row mb-5">
        <div class="col">
          <a href="index.html">
            <img src="~/assets/img/logos/logo-putauaki-white.png" alt="Putauaki Trust" id="logo-white" class="mb-3">  
          </a>
          <p
            class="pr-xl-3"
          >GROWING THE VALUE OF OUR ASSETS FOR THE BENEFIT OF ALL THE SHAREHOLDERS, TAKING INTO ACCOUNT SUSTAINABILITY AND PROTECTION OF OUR LAND</p>
        </div>
